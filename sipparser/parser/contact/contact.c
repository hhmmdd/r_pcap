 ...
 /*
 ****************************************************************
 *  Copyright  1999-2004,  eWingsTech Inc. - All Rights Reserved. 
 *  last update : 2004.7.13
 *  Author   : yanli
 *  filename : contact.c
 *  version  : 0.1
 *  last update date: 2004.9.7 by yanli
 ****************************************************************
 */
 ...
 */
static __inline int skip_uri(str* _s)
{
	register int st = ST1;
 ...
 * of URI
 */
static __inline int skip_name(str* _s)
{
	char* last_wsp, *p;
	int i, quoted = 0;
