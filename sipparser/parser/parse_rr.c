 ...
 */
static __inline void do_free_rr(rr_t** _r, int _shm)
{
	rr_t* ptr;
 ...
 */
static __inline void xlate_pointers(rr_t* _orig, rr_t* _r)
{
	param_t* ptr;
 ...
 */
static __inline int do_duplicate_rr(rr_t** _new, rr_t* _r, int _shm)
{
	int len, ret;
	rr_t* res;
