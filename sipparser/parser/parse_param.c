 ...
 */
static __inline void parse_contact_class(param_hooks_t* _h, param_t* _p)
{
 ...
 */
static __inline void parse_uri_class(param_hooks_t* _h, param_t* _p)
{
 ...
 * closing quote
 */
static __inline int parse_quoted_param(str* _s, str* _r)
{
	char* end_quote;
 ...
 */
static __inline int parse_token_param(str* _s, str* _r)
{
	int i;
 ...
 */
static __inline void parse_param_name(str* _s, pclass_t _c, param_hooks_t* _h, param_t* _p)
{
 ...
 * a single token.
 */
static __inline int parse_param_body(str* _s, param_t* _c)
{
	if (_s->s[0] == '\"') {
 ...
 */
static __inline void do_free_params(param_t* _p, int _shm)
{
	param_t* ptr;
 ...
 */
static __inline void print_param(FILE* _o, param_t* _p)
{
	char* type;
 ...
 */
static __inline int do_duplicate_params(param_t** _n, param_t* _p, int _shm)
{
	param_t* last, *ptr, *t;
